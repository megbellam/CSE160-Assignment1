...
function addActionsForHtmlUI(){
    ...
    document.getElementById('pictureButton').onclick   = function() { g_shapesList=[]; drawMyPicture();};
    document.getElementById('awButton').onclick   = function() { g_shapesList=[]; doAwesomeness();};
